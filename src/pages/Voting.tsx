...
import Voting from '../components/VotingList';
...
// Tän idea fetchata data, joka löytyy data.json tiedostosta --> tähän RSS feedistä dataa
  ...
  const rssFeedUrl = 'https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fwww.eduskunta.fi%2F_layouts%2F15%2Ffeed.aspx%3Fxsl%3D1%26web%3D%252FFI%252Frss%252Dfeeds%26page%3D09a1389c-9905-432f-a68b-dad4d2992beb%26wp%3Daae94984-39b7-459a-9912-7bf5d970b356%26pageurl%3D%252FFI%252Frss%252Dfeeds%252FSivut%252FHEt%252Easpx';
  ...
  return (
    <ThemeProvider theme={theme}>
      <AuthenticationBar />
      <Typography variant="h6">Feed Status: {status}</Typography>
      <Typography variant="h6">Number of Items Fetched: {items.length}</Typography>
      <Voting items={items} />
      <SingleVoting/>
      <Settings/>
      <VotingHistory/>
